...
for image_backbone_name, landmarks_backbone_name, merging_method in [
    ("resnet", None, "concatenate"),
    ("clip", None, "concatenate"),
    ("dinov2", None, "concatenate"),
    (None, "unprocessed", "concatenate"),
    (None, "linear", "concatenate"),
    (None, "mlp", "concatenate"),
    ("clip", "mlp", "concatenate"),
    ("clip", "mlp", "sum"),
]:
    content = create_dict(
        dataset="ml2hp",
    ...
    filename = f"ml2hp_loso_image-backbone={image_backbone_name}_landmarks-backbone={landmarks_backbone_name}_merging-method={merging_method}.yaml"
